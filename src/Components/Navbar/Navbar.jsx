...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-16 border-b border-[#EFEFEF] bg-white">
      <div className="flex w-[95%] h-full justify-end items-center gap-3 text-[#424242]">
        <div className="w-[45px] h-[45px] rounded-full object-contain">
          <img src={avatar} alt="" className="w-[45px] h-[45px] rounded-full" />
        </div>
