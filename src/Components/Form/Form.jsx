...
export const PhoneSelector = () => {
  ...
  const [selectedPhone, setSelectedPhone] = useState(countries[0].phone); // القيمة الافتراضية
    ...
    <div className="w-64 h-10  border border-slate-300 rounded  flex items-center">
      <div className="w-full flex px-2 gap-2">
        <select
          ...
          className="max-w-20 bg-white text-slate-400 border-r border-slate-400   focus:outline-none focus:ring focus:ring-transparent cursor-pointer"
        >
...
export const InputFile = () => {
  return (
    <input
      className="flex w-64 h-10 rounded border border-slate-300  border-input bg-white text-sm text-gray-400  file:bg-customBlue file:text-slate-50 file:border-2 file:border-customBlue file:text-sm file:font-medium file:h-full outline-none ring-1 ring-[transparent] focus:ring-[#93c5fd] cursor-pointer"
      type="file"
    />
  );
};
