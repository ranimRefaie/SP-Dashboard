      ...
      <div className="flex w-full h-full justify-between items-center">
        <div className="relative  w-[52%] h-[48px] ml-[5%]">
          <input
            ...
            className="outline-none ring-1 ring-[transparent] focus:ring-[#5a5a5a] placeholder:text-[#A4A4A4] pl-10 w-full h-full border rounded-lg bg-[#FAFAFA] border-[#E6E6E6]"
          />
          <svg
            stroke="currentColor"
            fill="currentColor"
            stroke-width="0"
            viewBox="0 0 24 24"
            className="absolute top-[19%] left-2 text-[#A4A4A4]"
            height="30"
            width="30"
